...
//文件下拉菜单的操作
    $(".tuexit").click(function(){
        erasers.css({display:"none"});
        draws.isshowxp=false;
        $(".tuexit>.tuexitlis").slideToggle(100);
    })
...
//截图
    ...
    var slices;
    var flags=true;
    var slicemove=document.querySelector(".slice-move");
    $(".slice").click(function(){
        ...
        copy.onmousedown=function(e){
            ...
            copy.onmousemove=function(e){
                ...
                cobj.clearRect(0,0,canvas.width,canvas.height);
                if(draws.historys.length>0){
                    cobj.putImageData(draws.historys[draws.historys.length-1],0,0);
                }
                cobj.beginPath();
                cobj.setLineDash([6, 6]);  
                cobj.rect(startx,starty,w,h);
                cobj.stroke();
            }
    ...
    slicemove.onmousedown=function(e){
        var sstartx=e.offsetX;
        var sstarty=e.offsetY;
        copy.onmousemove=function(e){
            var smovex=e.offsetX;
            var smovey=e.offsetY;
            var sw=smovex-sstartx;
            var sh=smovey-sstarty;
            cobj.drawImage(slicemove,startx,starty,w,h,smovex,smovey,w,h);
        }
